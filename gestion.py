...
GIT_GESTION = 'https://github.com/epfl-lts2/azimut-gestion.git'
GIT_DEPLOY = 'https://github.com/epfl-lts2/azimut-deploy.git'
GIT_CONFIG = 'https://github.com/epfl-lts2/azimut-config.git'
